...
class DbQueryResultCache {
    ...
    constructor(dataSource) {
        ...
        const { schema } = this.dataSource.driver.options;
        ...
        const cacheOptions = typeof this.dataSource.options.cache === "object"
            ...
            : {};
        const tableName = cacheOptions.tableName === "" ? undefined : cacheOptions.tableName;
        ...
        this.queryResultCacheTable = this.dataSource.driver.buildTableName(cacheTableName, schema, database);
    }
    // -------------------------------------------------------------------------
    // Public Methods
    // -------------------------------------------------------------------------
    ...
    getFromCache(options, queryRunner) {
        ...
        if (options.identifier) {
            return qb
                ...
                .setParameters({
                identifier: this.dataSource.driver.options.type === "mssql"
            ...
            return qb
                ...
                .setParameters({
                query: this.dataSource.driver.options.type === "mssql"
