...
class TreeRepository extends Repository_1.Repository {
     ...
     */
    findRoots(options) {
        const escapeAlias = (alias) => this.manager.dataSource.driver.escape(alias);
        const escapeColumn = (column) => this.manager.dataSource.driver.escape(column);
    ...
    createDescendantsQueryBuilder(alias, closureTableAlias, entity) {
        ...
        const escape = (alias) => this.manager.dataSource.driver.escape(alias);
        if (this.metadata.treeType === "closure-table") {
            ...
            return this.createQueryBuilder(alias)
                .innerJoin(this.metadata.closureJunctionTable.tablePath, closureTableAlias, joinCondition)
            ...
            return this.createQueryBuilder(alias).where((qb) => {
                ...
                if (DriverUtils_1.DriverUtils.isSQLiteFamily(this.manager.dataSource.driver)) {
