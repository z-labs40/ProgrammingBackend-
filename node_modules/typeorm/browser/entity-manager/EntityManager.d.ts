...
export declare class EntityManager {
     ...
     * @param options
     */
    update<Entity extends ObjectLiteral>(target: EntityTarget<Entity>, criteria: string | string[] | number | number[] | Date | Date[] | ObjectId | ObjectId[] | any, partialEntity: QueryDeepPartialEntity<Entity>, options?: UpdateOptions): Promise<UpdateResult>;
    /**
     ...
     * @param options
     */
    updateAll<Entity extends ObjectLiteral>(target: EntityTarget<Entity>, partialEntity: QueryDeepPartialEntity<Entity>, options?: UpdateOptions): Promise<UpdateResult>;
    /**
     ...
     */
    clear<Entity>(entityClass: EntityTarget<Entity>, options?: {
        cascade?: boolean;
    }): Promise<void>;
    /**
     ...
     * @param value
     */
    increment<Entity extends ObjectLiteral>(entityClass: EntityTarget<Entity>, conditions: FindOptionsWhere<Entity>, propertyPath: string, value: number | string): Promise<UpdateResult>;
    /**
     ...
     * @param value
     */
    decrement<Entity extends ObjectLiteral>(entityClass: EntityTarget<Entity>, conditions: FindOptionsWhere<Entity>, propertyPath: string, value: number | string): Promise<UpdateResult>;
    /**
